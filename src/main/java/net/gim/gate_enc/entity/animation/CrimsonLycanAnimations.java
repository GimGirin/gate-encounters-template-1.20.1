...
public class CrimsonLycanAnimations {
	public static final Animation CRIMSON_LYCAN_MELEE = Animation.Builder.create(1.125F)
		...
		.addBoneAnimation("crimson_lycan", new Transformation(Transformation.Targets.SCALE, 
	...
	public static final Animation CRIMSON_LYCAN_IDLE = Animation.Builder.create(1.25F).looping()
			.addBoneAnimation("head", new Transformation(Transformation.Targets.ROTATE,
					new Keyframe(0.0F, AnimationHelper.createRotationalVector(0.0F, 0.0F, 0.0F), Transformation.Interpolations.LINEAR),
	...
	public static final Animation CRIMSON_LYCAN_RUN = Animation.Builder.create(1.3333F).looping()
		.addBoneAnimation("crimson_lycan", new Transformation(Transformation.Targets.ROTATE, 
			new Keyframe(0.0F, AnimationHelper.createRotationalVector(0.0F, 0.0F, 0.0F), Transformation.Interpolations.LINEAR),
