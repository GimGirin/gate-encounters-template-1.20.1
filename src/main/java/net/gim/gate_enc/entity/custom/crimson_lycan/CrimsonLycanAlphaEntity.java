...
public class CrimsonLycanAlphaEntity extends CrimsonLycanEntity {
    public CrimsonLycanAlphaEntity(EntityType<? extends HostileEntity> entityType, World world) {
        super(entityType, world);
    }

    public static DefaultAttributeContainer.Builder createCrimsonLycanAlphaAttributes() {
